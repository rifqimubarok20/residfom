        ...
        <div class="container-fluid">
            <form action="" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input value="<?= $fasilitas['nama_peminjam']; ?>" type="text" name="nama_peminjam"
                        class="form-control" id="nama_peminjam">
                ...
                <div class="mb-3">
                    ...
                    <input value="<?= $fasilitas['nama_fasilitas']; ?>" type="text" name="nama_fasilitas"
                        class="form-control" id="nama_fasilitas">
                    <small class="form-text text-danger">
                ...
                <div class="mb-3">
                    ...
                    <input value="<?= $fasilitas['tgl_kembali']; ?>" type="date" name="tgl_kembali" class="form-control"
                        id="tgl_kembali">
                    <small class="form-text text-danger">
